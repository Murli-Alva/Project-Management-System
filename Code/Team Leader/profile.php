...
error_reporting(0);
  ...
  if(($userprofile1 == true) && ($userprofile2 == 'Team Leader'))
  {
								...
								<div class="profile-view">
									<div class="profile-img-wrap">
										<div class="profile-img">
											<a href="#"><img class="avatar" src="<?php echo $_SESSION['pic_source'];?>" alt=""></a>
										</div>
									</div>
										...
										<div class="row">
											<div class="col-md-5">
												<div class="profile-info-left">
													...
													<div class="staff-id">Employee ID : <?php echo $_SESSION['e_id'];?></div>
												</div>
											</div>
											<div class="col-md-7">
												<ul class="personal-info">
													...
													<li>
														...
														<span class="text"><?php echo $_SESSION['birth_date'];?></span>
													</li>
													<li>
